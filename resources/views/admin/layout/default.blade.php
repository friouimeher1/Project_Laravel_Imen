					...
					<div class="header-left">
								...
								<ul class="nofitications-dropdown">
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
											   <div class="user_img"><img src="{{url('backend/images/p4.png')}}" alt=""></div>
											...
											<li class="odd"><a href="#">
												<div class="user_img"><img src="{{url('backend/images/p2.png')}}" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor </p>
												<p><span>1 hour ago</span></p>
												</div>
											...
											<li><a href="#">
											   <div class="user_img"><img src="{{url('backend/images/p3.png')}}" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
                      ...
                      <span class="badge blue"></span>
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
												<div class="user_img"><img src="{{url('backend/images/p5.png')}}" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
											 ...
											 <li class="odd"><a href="#">
												<div class="user_img"><img src="{{url('backend/images/p6.png')}}" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
											 ...
											 <li><a href="#">
												<div class="user_img"><img src="{{url('backend/images/p7.png')}}" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">
												<span class="prfil-img"><img src="{{url(Auth::guard('admin')->user()->image)}}" alt=""> </span>
												<div class="user-name">
													<p></p>
...
<!--slider menu-->
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        <li id="menu-home" ><a href="{{url('admin/home1')}}"><i class="fa fa-tachometer"></i><span>Accueil</span></a></li>
		        <li><a href=""><i class="fa fa-cogs"></i><span>Gestion des artisans </span><span class="fa fa-angle-right" style="float: right"></span></a>
